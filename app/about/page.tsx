...
export default function About() {
  return (
    <>
      ...
      {/* <section className="grid grid-cols-2 mb-8 mt-16">
      ...
      <section className="mb-8" id="awards">
        ...
        <p>
          <span className="font-semibold">Highly Commended</span> - RSA Student <br />
          Design Awards In Your Skin Brief 2023-2024
        </p>
      </section>
